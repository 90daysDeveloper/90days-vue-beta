  ...
  <div class="register d-flex justify-content-center align-items-center">
    <form @submit.prevent="handleSubmit">
      ...
      <div class="form-group password">
        ...
        <input class="form-control" id="password" v-model="password" placeholder="Password"
      ...
      <div class="form-group password">
        ...
        <input class="form-control" id="password" v-model="confermapassword" placeholder="Conferma la password"
          :type="visible ? 'text' : 'password'">
      ...
      <div class="form-check mt-4">
        ...
        <label class="form-check-label" for="rimani-connesso">Accetto la <a
            href="https://www.iubenda.com/privacy-policy/10762418/legal" target="_blank">privacy policy</a> ed i <a
